...
### I want to easily understand the main areas of research of the group and learn more about it.
  ...
  - Users can scroll down and read the main goals of the group.

    <img src="assets/images/testing_user_stories/user_stories_2.jpg" alt="The main goals of the group." width="500px" height="auto">

  - Users can click on *Research* at the navigation bar, appreciate microfabricated scaffolds illustrated in the hero image and get a first impression on the scientific activity of the group. 
  ...
  - A text below than briefly describes the main concepts (this is also supported by a schematic image and video where one of the PhD students of the group describes his research project). 
...
### I want to be able to easily navigate throughout the website to find content.
  ...
  - As it is usually expected by users, at the bottom of each page there is a footer that contains contact information and social links.
...
### I want to find contact information for discussing possible collaborations.
  ...
  - Email addresses of the key group members (group leader and PhD students) are provided on the *People* page next to the photos.
